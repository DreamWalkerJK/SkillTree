...
<div class="domain-grid">
  ...
  <a class="domain-card" href="#/Network/网络模型"><span class="domain-icon" aria-hidden="true">SYS</span><div class="domain-copy"><span class="domain-index">08 / DOMAIN</span><h3>Systems</h3><p>网络模型、Linux、Windows、通用编码技能与开源合规。</p></div><span class="domain-arrow" aria-hidden="true">↗</span></a>
</div>

<div class="section-heading section-heading-recommended"><div class="section-heading-copy"><span class="section-kicker">CURATED STARTING POINTS</span><h2>推荐入口</h2></div><span class="section-count">精选 13 篇</span></div>
...
<li><a href="#/GeneralCodingSkills/开源协议（Open%20Source%20License）">开源协议（Open Source License）</a></li>
</ul></div>
